...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-[#0a0e1a] bg-grid"
    >
      {/* Ambient glow blobs */}
      ...
      <div className="max-w-6xl mx-auto px-6 py-24 pt-32 w-full relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex items-center gap-2 mb-6 h-10">
            ...
            <span className="font-mono text-xl md:text-2xl text-[#00d4ff] font-semibold min-w-0">
              {displayed}
            </span>
            <span className="w-0.5 h-7 bg-[#00d4ff] animate-blink shrink-0" />
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="h-px w-12 bg-[#1e2d50]" />
      ...
      {/* Terminal block — only on XL screens, absolutely positioned */}
      <div className="hidden xl:block absolute right-16 top-1/2 -translate-y-1/2 w-72 rounded border border-[#1e2d50] bg-[#0f1629] overflow-hidden glow-cyan">
        ...
        <div className="p-4 font-mono text-xs space-y-2">
          ...
          <div className="mt-2"><span className="text-[#00d4ff]">$</span> <span className="text-[#94a3b8]">terraform apply</span></div>
          <div className="text-[#00ff88]">Apply complete! 47 added.</div>
